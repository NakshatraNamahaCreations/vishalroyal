...
// Static build (Hostinger) needs a full URL to the Vercel-hosted API.
// Server build and dev fall back to the same-origin route.
const ENQUIRY_URL = process.env.NEXT_PUBLIC_ENQUIRY_URL ?? "/api/enquiry";
